...
Setting up Archanid is straightforward. Follow this guide to ensure the bot has the necessary permissions to function correctly.
...
!!! failure "Don't see commands?"
    If typing `/` does not show Archanid's commands:
    
    1.  Go to **Server Settings > Integrations > Bots & Apps**.
    2.  Ensure Archanid is listed.
